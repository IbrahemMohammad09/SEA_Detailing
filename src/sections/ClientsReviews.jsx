...
const staticReviews = [
  {
    name: "John Smith",
    message:
      "Excellent service and professional work. The team was very helpful and responsive.",
    rate: 5,
  },
  {
    name: "Michael Brown",
    message:
      "Great experience from start to finish. Very professional and high-quality service.",
    rate: 5,
  },
  {
    name: "David Wilson",
    message:
      "Amazing service and excellent communication. Highly recommended.",
    rate: 4,
  },
  {
    name: "James Anderson",
    message:
      "Very satisfied with the service. Everything was handled professionally.",
    rate: 5,
  },
];
...
const ClientsReviews = () => {
  ...
  */
  ...
  // =====================================================
  // Backend Submit Review - DISABLED
  // =====================================================
  ...
  return (
    <div className="mt-10">
      ...
      */}
            ...
            <div className="flex justify-center gap-10 h-[600px] pb-10 mx-auto">
              ...
              {reviews.slice(0, 3).map((review, index) => (
                <div
                  ...
                  style={{
                    boxShadow: "0px 10px 20px rgba(0, 0, 0, 0.3)",
                    marginLeft: index === 1 ? "30px" : "0",
                    marginRight: index === 1 ? "30px" : "0",
                  }}
                >
                  <h3 className="text-2xl font-semibold text-gray-900">
                    {review.name}
      ...
      Backend Loading closing tag - DISABLED
      */}
