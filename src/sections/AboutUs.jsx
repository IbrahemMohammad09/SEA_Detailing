...
export default function AboutUs(){
   ...
   <div className='mt-24 mx-auto'>
     ...
     <div className="flex flex-col-reverse  justify-center items-center lg:flex-row gap-28 px-10 md:px-32 container-about">
        <div>
            <p className="font-work font-bold text-3xl text-[#555555] max-w-[600px]">QUICKLY AND EASY TO CLEAN YOUR OFFICE AND HOUSE</p>
            <p className="font-work font-normal text-base text-[#292929] mt-4 max-w-[500px]">Amet minim mollit non deserunt ullamco 
             sit aliqua dolor do consequat sunt nostrud amet. 
            Amet minim mollit non deserunt ullamco aliqua dolo ame.</p>
            <button onClick={()=>navigate('/book-service')} className="text-white bg-[#1195FF]  font-semibold text-3xl rounded-4xl w-64 py-3.5 px-9 hover:bg-blue-600  hover:shadow-xl font-lora mt-8 mb-12">
               Book Services
            </button>
        </div>
