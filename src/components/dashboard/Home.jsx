...
export default function HomeDahboard(){
   ...
   <div className=" md:flex  gap-14 ">
    <SideBar/>
    <div>
        <p className=" mb-20 text-[#1A78F2] font-bold text-3xl mt-16 pl-5 md:pl-0 font-source">لوحة التحكم</p>
        <div className="flex flex-col justify-center items-center md:flex-row flex-wrap  gap-24 mx-4 mb-8">
            ...
            <RiProfileFill  className="text-[#1A78F2]  text-4xl" />
                <p className=" font-semibold text-2xl font-source">معرض الصور</p>
            </Link>
            ...
            <MdBorderColor className="text-[#1A78F2] text-4xl" />
                <p className="  font-semibold text-2xl font-source">الطلبات</p>
            </Link>
